...
function createMenuItem(name, price, category) {
  return { name, price, category }; /*Your code here*/
}
...
*/
// console.log(createMenuItem("Soda", "5", "Drink"));
// console.log(createMenuItem("Hotdog", "5", "Lunch"));
// console.log(createMenuItem("Vanilla Cone", "5", "Desert"));
...
// console.log(burger.discount("dog"));
///////////////Reviews (MVP)///////////////////
const reviews = [
  {
    name: "Daniela",
